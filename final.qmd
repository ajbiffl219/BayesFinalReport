...
greedy model without healthy food
...
all_fit_file <- "best_fit_4_mixed.rda"
overwrite <- FALSE
...
stan_trace(lin_fit, pars = c("beta", "sigmasq", "mu[1]", "mu[2]", "mu[3]", "mu[4]", "mu[5]"))
...
lin_mcmc <- As.mcmc.list(lin_fit, pars = c("beta", "sigmasq"))
